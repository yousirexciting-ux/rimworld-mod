import { DAYS_TO_SIMULATE, HOURS_PER_DAY, TICKS_PER_HOUR } from "./config.js";
import { ActionGates } from "./actionGates.js";
import { Pawn } from "./pawn.js";
import { World } from "./world.js";
function formatPercent(value) {
  return `${(value * 100).toFixed(1)}%`;
}
function printDay(day, pawn) {
  ...
  const actions = ["move", "meditate", "breakThroughTry", "gather", "firstAid"];
